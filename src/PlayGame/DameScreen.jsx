...
return(
    <PageWrapper>
        ...
        <div className='flex flex-row items-start gap-4 p-6 shrink-0' >
            ...
            <button onClick={getBoardState} className='absolute bottom-5 right-5 border-none p-3 w-40 text-xl rounded-lg cursor-pointer bg-linear-to-br from-[#A47551] to-[#6B4226] text-[#F7E7CE] uppercase font-bold hover:scale-95 transition-smooth duration-300'>I've played</button>
